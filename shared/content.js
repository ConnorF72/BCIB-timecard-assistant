// Content script injected into fdtpro.com. Relies on parseNicknameMap(),
// getNicknameMap(), normalizeName(), timeToMinutes() and minutesToTime()
// from shared.js, which manifest.json loads immediately before this file.
